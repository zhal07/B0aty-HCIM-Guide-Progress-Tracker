...
An interactive checklist tracker for the B0aty HCIM (Hardcore Ironman Mode) guide for Old School RuneScape (OSRS).
...
- **Quick Actions**: 
  - Jump to your current incomplete task
  - Expand/collapse all banks at once
  - Mark all tasks complete in one click
...
2. Select an episode using the episode buttons at the top
3. Click on tasks to mark them as complete
4. Use the utility buttons to manage your progress:
   - **Resume**: Jump back to your last incomplete task
